...
<head>
	...
	<!-- CSS files -->
	<link rel="stylesheet" href="<?php echo base_url('assets/dizisitesi/') ?>css\plugins.css">
	<link rel="stylesheet" href="<?php echo base_url('assets/dizisitesi/') ?>css\style.css">
