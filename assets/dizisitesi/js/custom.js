$(function(){
	...
	var sifreunuttumLink = $(".sifreunuttumLink");
	var sifremiunuttumct=$("#sifreunuttum-content");
    ...
    // sifremi unuttum popup form
     sifreunuttumLink.on('click', function(event){
    	event.preventDefault();
    	sifremiunuttumct.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
		if ($(target).hasClass("overlay")){
